var signals = {
  methods: {
    ...
    SIGNAL_DEPENDS_ON_MEMORY(sender, filename = null, receiver = "connector", slot = "slotSendCommands") {
      return {
    ...
    // 读小文件用,内存足够的情况下,提高效率
    SIGNAL_GET_CODE(sender, filename = null, receiver = "connector", slot = "slotSendCommands") {
      return {
        event: "getCode",
        sender: sender,
        receiver: receiver,
